...
if __name__ == '__main__':
	...
	get_all_tweets("rizacalimbay")
	get_all_tweets("AndreCastro88")
	get_all_tweets("Ryan_Donk18")
	get_all_tweets("AdemByK21")
	get_all_tweets("TunayTorun55")
	get_all_tweets("ErenDerdiyok1")
	get_all_tweets("veyselsari")
	get_all_tweets("YonathaDelValle")
	get_all_tweets("kartal117")
