...
if __name__ == '__main__':
	...
	get_all_tweets("S_Holmen84")
	get_all_tweets("uslumehmet54")
	get_all_tweets("alituran38")
	get_all_tweets("meha_alban")
	get_all_tweets("ay_selim")
	get_all_tweets("halilibosonmezz")
