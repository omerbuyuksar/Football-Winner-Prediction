...
if __name__ == '__main__':
	...
	get_all_tweets("Ayhylc02")
	get_all_tweets("volkanbabacann")
	get_all_tweets("bekirtegun")
	get_all_tweets("Ceko___")
	get_all_tweets("EmreBelozoglu80")
	get_all_tweets("CansevGencer")
