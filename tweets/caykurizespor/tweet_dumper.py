...
if __name__ == '__main__':
	...
	get_all_tweets("karamanhikmet")
	get_all_tweets("ahmet9ilhan")
	get_all_tweets("AlbayrakEren")
	get_all_tweets("akyuz_17")
	get_all_tweets("TuszynskiPatryk")
	get_all_tweets("SRCNKY7")
