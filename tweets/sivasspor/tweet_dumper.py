...
if __name__ == '__main__':
	...
	get_all_tweets("Chahechouhe92")
	get_all_tweets("KoneDjakari")
	get_all_tweets("michaeleneramo")
	get_all_tweets("yek_35")
	get_all_tweets("bthn65")
	get_all_tweets("KorcanCelikay")
