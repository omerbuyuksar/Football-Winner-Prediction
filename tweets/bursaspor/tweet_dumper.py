...
if __name__ == '__main__':
	...
	get_all_tweets("Hhamza_official")
	get_all_tweets("MertGunok")
	get_all_tweets("Necka7")
	get_all_tweets("emre_tsdmr3")
	get_all_tweets("luisadvincula17")
	get_all_tweets("NounkeuD")
	get_all_tweets("rickyfaty")
